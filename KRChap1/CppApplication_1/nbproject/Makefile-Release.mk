...
${OBJECTDIR}/1.2example1.o: 1.2example1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1.2example1.o 1.2example1.c

${OBJECTDIR}/1.3example2.o: 1.3example2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1.3example2.o 1.3example2.c

${OBJECTDIR}/1.5example3.o: 1.5example3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1.5example3.o 1.5example3.c

${OBJECTDIR}/1.5exercise1.o: 1.5exercise1.6 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1.5exercise1.o 1.5exercise1.6
